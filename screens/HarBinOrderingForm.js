...
export default class HarBinOrderingForm extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      pickupFront: 'No',
      pickupBack: 'No',
      siteAddress: 'HAR Covered Crops, 292 Harrisville Road, Tuakau 2121',
    };
  ...
  //INCREMENT AND DECREMENT BACK SIDE HAR 15M GENERAL WASTE
  ...
  //INCREMENT AND DECREMENT BACK SIDE HAR 15M GREEN WASTE

  incrementBack15Green = () => {
    this.setState({
      back15MGreen: this.state.back15MGreen + 1,
      pickupBack: 'Yes',
    });
  };
  ...
  //INCREMENT AND DECREMENT BACK SIDE HAR 30M GREEN WASTE
  ...
  //INCREMENT AND DECREMENT BACK SIDE HAR 30M GENERAL WASTE
  ...
  //INCREMENT AND DECREMENT FRONT SIDE HAR 15M GENERAL WASTE
  ...
  //INCREMENT AND DECREMENT FRONT SIDE HAR 15M GREEN WASTE
  ...
  //INCREMENT AND DECREMENT FRONT SIDE HAR 30M GREEN WASTE
  ...
  //INCREMENT AND DECREMENT FRONT SIDE HAR 30M GENERAL WASTE
  ...
  saveFormToDb = () => {
    ...
    if (pickupDateTime) {
      ...
      const scriptUrl =
        'https://script.google.com/macros/s/AKfycbyM0SG2X6t8_UdQj-RQb0gM12wBK_fXZycVDmts_kTIuD727bI/exec';
      const url = `${scriptUrl}?
      callback=ctrlq&action=${'doPostHarData'}&entry_id=${ID}&site_name=${
      ...
      <View style={styles.container}>
        <ImageBackground
          ...
          <ScrollView
            ...
            <Text style={styles.headerText}>HAR Bin Ordering Form</Text>
            ...
            <Text style={styles.headerText2}>Back Side of HAR</Text>
            ...
            <Text style={styles.headerText2}>Middle Side of HAR</Text>
